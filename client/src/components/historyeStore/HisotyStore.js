			...
			<div className='container'>
				...
				<div className='xm:flex xm:justify-between xs:justify-center xx:justify-center xy:justify-center pb-3'>
					<div className='bg-[#3E3E44] p-6 ss:w-[47%] xm:w-full text-center rounded-3xl'>
						...
						<div className='xs:hidden xx:hidden xy:hidden ss:block'>
							<Image src={logo}  />
						</div>
					...
					<div className='w-[47%] xs:hidden xx:hidden xy:hidden ss:block rounded-3xl h-96 overflow-hidden'>
				...
				<div className='justify-between sm:justify-between items-start mt-6 xs:hidden xx:hidden xy:hidden xm:hidden ss:hidden sm:flex'>
